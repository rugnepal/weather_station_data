...
```{r}
hchart(bag_data,"spline",hcaes(x = datetime_to_timestamp(localDateTime), y = waterLevel, color = risk_level),name = "Heil Hydara")  %>% hc_xAxis(title ="",type = 'datetime') %>% hc_title(text = "Timeseries of Bagmati")
```
...
```{r}
hchart(aru_data,"spline",hcaes(x = datetime_to_timestamp(localDateTime), y = waterLevel, color = risk_level),name = "Arun Khola")  %>% hc_xAxis(title = "",type = 'datetime') %>% hc_title(text = "Timeseries of Arun Khola")
```


```{r}
hchart(sap_data,"spline",hcaes(x = datetime_to_timestamp(localDateTime), y = waterLevel,  color = risk_level),name = "Sapta Khosi")  %>% hc_xAxis(title="",type = 'datetime') %>% hc_title(text = "Timeseries of  Sapta Khosi")
```

```{r}
hchart(tam_data,"spline",hcaes(x = datetime_to_timestamp(localDateTime), y = waterLevel),name = "Tamor Khola")  %>% hc_xAxis(title="",type = 'datetime') %>% hc_title(text = "Timeseries of  Tamor")
```
